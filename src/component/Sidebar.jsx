const Sidebar = ({tab,setTab}) =>{
  ...
  function handleCLik(data){
    ...
    return (
       <>
       <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark height" style={{width: '280px'}}>
    ...
    <ul className="nav nav-pills flex-column mb-auto">
      <li className="nav-item" onClick={()=>handleCLik('Home')}>
      ...
      <li onClick={()=>handleCLik('Create Post')}>
        <a href="#"  className={`nav-link ${tab == 'Create Post' && 'active'} `}>
